...
class MultiColor extends TSPattern {
  ...
  final BasicParameter hue1Param = new BasicParameter("Hue1", 1, 1, 360);
  final BasicParameter bright1Param = new BasicParameter("Bright1", 50, 0, 100);
  final BasicParameter hue2Param = new BasicParameter("Hue2", 100, 1, 360);
  final BasicParameter bright2Param = new BasicParameter("Bright2", 50, 0, 100);
  final BasicParameter hue3Param = new BasicParameter("Hue3", 200, 1, 360);
