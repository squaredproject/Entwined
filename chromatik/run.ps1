...
rm -Force -ea 0 ~/Chromatik/Packages/entwined-1.0.1-SNAPSHOT.jar
...
$c_args = "-cp $cwd/lib/chromatik-1.0.1-windows-x64.jar heronarts.lx.studio.Chromatik --warnings --disable-zeroconf --enable-plugin entwined.plugin.Entwined Projects/entwined.lxp".Split(" ")
